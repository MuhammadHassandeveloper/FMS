...
if($cgpa==""||$attendance=="")
{
  ...
  echo  $query1="UPDATE `results_attendance` SET `cgpa`='$cgpa',`attendance`='$attendance' WHERE r_id='$id'";
    global $connection;
	...
	<div class="main-container col-md-8" style="margin-left:120px;">
		<div class="">
			<div class="min-height-300px">
				<div class="pd-20 card-box mb-30">
					 <h3 class="p-3">Edit Result and Attendance</h3>
					    <!----------------------- success msg ---------------------------->
						<?php
        ...
        <?php
                   ...
                   ?>
					...
					<?php  
 $id=$_GET['id'];
 $sql="SELECT * FROM results_attendance WHERE r_id='$id'";
							...
							<section class="col-md-12">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="hidden" name="id" value="<?php echo $row['r_id'] ?>" class="form-control">
											<label >CGPA :</label>
											<input type="text" name="cgpa" value="<?php echo $row['cgpa'] ?>" class="form-control">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<label >attendance</label>
											<input type="text" name="attendance" value="<?php echo $row['attendance'] ?>"   class="form-control">
										</div>
									</div>
								</div>
