...
$sql="SELECT s_id FROM `student_courses` WHERE s_id='$sid'";
$res=mysqli_query($connection,$sql);
$row=mysqli_num_rows($res);
if($row>0)
{
$_SESSION['errormsg']="u already assign this course to this student";	
header("Location:student_list.php");
}
else{
$sql="INSERT INTO `student_courses`(`s_id`, `cours_id`) VALUES ('$sid','$coursid')";
$res=mysqli_query($connection,$sql);
if($res)
{
...
<br>
							...
							<button class="btn btn-md btn-primary w-100" type="submit" name="course">Submit</button>
