		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Admin  replies</h4>
						...
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th  class="text-center">Admin Replies</th>
								</tr>
							</thead>
							<tbody>
                                <?php 
$sid=$_SESSION['student_id'];
$sql="SELECT * FROM `admin_replies` WHERE s_id='$sid' ORDER BY id ASC;";
$res=mysqli_query($connection,$sql);
foreach($res as $row)
{
?>
								<tr>
									<td class="text-center"><?php   echo $row['reply']   ?> </td>
